...
[![favorites](../../../assets/flutter_favorite.png)](https://flutter.dev/docs/development/packages-and-plugins/favorites)
...
![screenshots 1](https://raw.githubusercontent.com/aboutyou/dart_packages/be222ddd96233574f46b7ac512ec1e0735a9362d/assets/sign_in_with_apple/screenshots/1.png)

![screenshots 2](https://raw.githubusercontent.com/aboutyou/dart_packages/be222ddd96233574f46b7ac512ec1e0735a9362d/assets/sign_in_with_apple/screenshots/2.png)
...
If you don't have one yet, create a new one at [Bundle IDs](https://developer.apple.com/account/resources/identifiers/list/bundleId) following these steps:
...
Next go to ["Service IDs"](https://developer.apple.com/account/resources/identifiers/list/serviceId) and follow these steps:
...
In order to communicate with Apple's servers to verify the incoming authorization codes from your app clients, you need to create a key at [Auth Keys](https://developer.apple.com/account/resources/authkeys/list):
...
To get started with the Glitch-based example go to the project's page at [flutter-sign-in-with-apple-example](https://glitch.com/~flutter-sign-in-with-apple-example) and click "Remix this". Now you have your own copy of the sample server!
...
Now update the services you created earlier at [Service IDs](https://developer.apple.com/account/resources/identifiers/list/serviceId) to include the following URL under `Return URLs`: `https://[YOUR-PROJECT-NAME].glitch.me/callbacks/sign_in_with_apple` (replacing the name inside the `[]`).
...
In case you are not yet using Android V2 Embedding, please first upgrade your app using the following guide: [Android V2 Embedding Upgrade](https://github.com/flutter/flutter/wiki/Upgrading-pre-1.12-Android-projects)
