...
public enum SignInWithAppleGenericError {
    ...
    func toFlutterError() -> FlutterError {
        ...
        case let .missingArguments(call):
            return FlutterError(
                code: "missing-args",
                message: "Missing arguments",
                details: call.arguments
            )
        case let .missingArgument(call, key):
            return FlutterError(
                code: "missing-arg",
