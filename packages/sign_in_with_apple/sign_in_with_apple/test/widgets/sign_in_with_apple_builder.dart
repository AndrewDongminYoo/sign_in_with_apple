...
void main() {
  ...
  testWidgets('Should render widget if Sign in with Apple is enabled', (tester) async {
    var calls = 0;
  ...
  testWidgets('Should render the fallback if Sign in with Apple is not available', (tester) async {
    var calls = 0;
    ...
    await tester.runAsync(() async {
      await tester.pumpWidget(
        SignInWithAppleBuilder(
          builder: (context) => Builder(builder: (context) => const SizedBox.shrink()),
